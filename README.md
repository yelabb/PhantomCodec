...
PhantomZip is one component of the **Phantom Stack**, an integrated ecosystem for real-time brain-computer interface (BCI) research and development:
...
| **[PhantomZip](https://github.com/yelabb/PhantomZip)** ← *You are here* | Ultra-low latency neural data compression codec optimized for embedded systems and real-time streaming | Rust |
