...
fn main() {
    ...
    let original = [
        2048, 2050, 2049, 2051, 2048, 2052, 2047, 2053,
        2046, 2054, 2045, 2055, 2044, 2056, 2043, 2057,
        2042, 2058, 2041, 2059, 2040, 2060, 2039, 2061,
        2038, 2062, 2037, 2063, 2036, 2064, 2035, 2065,
    ];
